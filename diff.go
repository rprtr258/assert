...
var none iter.Seq[diffLine] = func(func(diffLine) bool) {}
...
func diffImpl(selectorPrefix string, expected, actual any) iter.Seq[diffLine] {
	...
	case reflect.Invalid:
		return none
	case reflect.Bool:
		if e, a := expected.(bool), actual.(bool); e != a { //nolint:forcetypeassert
			return slices.Values([]diffLine{{selector: selectorPrefix, comment: "", expected: e, actual: a}})
		}
